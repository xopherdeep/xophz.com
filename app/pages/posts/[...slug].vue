...
<template>
  <div class="post-detail-container" v-if="post">
    <nav class="back-nav">
      <NuxtLink to="/posts" class="back-link" aria-label="Back to posts list">
      ...
      <footer class="article-footer">
        ...
        <div class="share-row" role="group" aria-label="Share options">
          ...
          <button
            ...
            @click="copyLink"
          >
            <svg v-if="!copySuccess" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
.prose :deep(h2) { font-size: 1.75rem; font-weight: 700; }
.prose :deep(h3) { font-size: 1.35rem; font-weight: 600; }

.prose :deep(p) { margin: 0 0 1.25rem; }
...
.share-twitter { background: rgba(228, 228, 231, 0.08); border-color: rgba(228, 228, 231, 0.15); color: #e4e4e7; }
.share-twitter:hover { background: rgba(228, 228, 231, 0.14); border-color: rgba(228, 228, 231, 0.25); }

.share-linkedin { background: rgba(10, 102, 194, 0.15); border-color: rgba(10, 102, 194, 0.3); color: #60a5fa; }
.share-linkedin:hover { background: rgba(10, 102, 194, 0.22); border-color: rgba(10, 102, 194, 0.45); }

.share-reddit { background: rgba(255, 69, 0, 0.1); border-color: rgba(255, 69, 0, 0.22); color: #f97316; }
.share-reddit:hover { background: rgba(255, 69, 0, 0.16); border-color: rgba(255, 69, 0, 0.35); }

.share-copy { background: rgba(139, 92, 246, 0.1); border-color: rgba(139, 92, 246, 0.22); color: #a78bfa; font-family: inherit; }
.share-copy:hover { background: rgba(139, 92, 246, 0.16); border-color: rgba(139, 92, 246, 0.35); }

.share-copy.copied { background: rgba(16, 185, 129, 0.12); border-color: rgba(16, 185, 129, 0.3); color: #34d399; }
