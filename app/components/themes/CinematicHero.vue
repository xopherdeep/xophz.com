...
import { Calendar as LucideCalendar, Briefcase as LucideBriefcase, FileText as LucideFileText, ArrowUpRight as LucideArrowUpRight } from '@lucide/vue'
...
<template>
  <section class="cinematic w-full min-h-[calc(100dvh-152px)] flex flex-col items-center justify-center gap-7 px-4 py-6" aria-label="Home">
    ...
    <!-- Actions -->
    <div
      class="flex flex-col sm:flex-row gap-3.5 w-full max-w-[440px]"
