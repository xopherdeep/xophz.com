...
export function useCommandPalette() {
  ...
  const staticPages = computed<CommandItem[]>(() => [
    ...
    { id: 'page-timeline', title: 'Career Timeline', subtitle: '24+ year chronological archive of 17 verified career milestones', category: 'pages', categoryLabel: 'Page', icon: 'i-lucide-history', iconColor: '#8b5cf6', route: '/timeline', keywords: ['timeline', 'career', 'history', 'experience', 'jobs', 'archive'] },
